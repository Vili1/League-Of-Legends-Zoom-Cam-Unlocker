...
int main() {
    ...
    std::vector<DWORD> pointsOffsets{ 0x8, 0x10, 0x3B4, 0x24, 0x4, 0x4, 0x254 };
    ...
    std::vector<DWORD> pointsOffsets2{ 0x8, 0x10, 0x3B4, 0x24, 0x4, 0x4, 0x170 };
    ...
    //up and down offset
    std::vector<DWORD> pointsOffsets3{ 0x8, 0x10, 0x3B4, 0x24, 0x4, 0x4, 0x168 };
