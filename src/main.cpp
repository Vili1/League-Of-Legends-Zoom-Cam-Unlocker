...
int main() {
    ...
    std::vector<DWORD> pointsOffsets{ 0x8, 0x10, 0x9A8, 0x4, 0x20, 0x0, 0x4, 0x260 };
    ...
    std::vector<DWORD> pointsOffsets2{ 0x8, 0x10, 0x9A8, 0x4, 0x20, 0x0, 0x4, 0x17C };
    ...
    //up and down offset
    std::vector<DWORD> pointsOffsets3{ 0x8, 0x10, 0x9A8, 0x4, 0x20, 0x0, 0x4, 0x174 };
